...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginboxTextController ??= TextEditingController();
    _model.loginboxFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/DALLE_2025-02-05_14.02.24_-_A_minimalist_square_logo_using_only_two_colors__red_and_blue._The_design_should_be_simple_and_bold,_with_clean_lines_and_a_modern_aesthetic._No_cartoo.webp',
                        width: 100.0,
                        fit: BoxFit.cover,
                      ),
                    ),
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: const Color(0x0090DF8B),
                              tabs: const [
                                Tab(
                                  text: 'Signup',
                                ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.loginboxTextController,
                                          focusNode: _model.loginboxFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.loginboxTextController',
                                            const Duration(milliseconds: 2000),
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .loginboxTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      SizedBox(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.loginboxTextController.text,
